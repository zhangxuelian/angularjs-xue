angular.module("uib/template/table/table.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/table/table.html",
    ...
    "                <button class=\"btn btn-default\" type=\"button\" ng-if=\"tableConfig.showTableCol\" id=\"showTableCol1\" ng-class=\"{'tooltip-btn':tableConfig.toolbar.tools.length}\">\n" +
    ...
    "                            <gx-checkbox ng-checked=\"tableConfig.selectAllColumn\"></gx-checkbox>\n" +
    "                            <label>全选</label>\n" +
    "                        </span>\n" +
    "                    </div>\n" +
    ...
    "                                <gx-checkbox ng-checked=\"colunm.show\"></gx-checkbox>\n" +
    ...
    "        </div>\n" +
    "    </div>\n" +
    "    <div class=\"table-content\" ng-class=\"{'th-border':tableConfig.drag}\">\n" +
    ...
    "                    <gx-checkbox ng-checked=\"tableConfig.selectAll\" ng-click=\"selectAll()\"></gx-checkbox>\n" +
    "                </th>\n" +
    ...
    "                    ng-click=\"!!row[item.id] ? item.callback(row):noPermission()\" class=\"{{item.className ? item.className : row[item.id]}}\" title=\"{{item.name}}\"><span ng-if=\"item.showText\">{{item.name}}</span></a>\n" +
    "                </td>\n" +
    "            </tr>\n" +
